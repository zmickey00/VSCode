...
\section*{Results}
After running the Metropolis-Hastings script with a sufficient number of iterations, the following final key was determined:

\subsection*{Best Key ($s^*$)}
\begin{verbatim}
mxwypathiskunzodbfgejclqrv
\end{verbatim}

\subsection*{Decrypted Message}


Using the best key, the decrypted message is:

wou hurt ang lie ah tell donna never doogbpe saw donna never frw wou pace donna never wou gesert ang aroung run donna never gomn wou let donna never Iz wou dive donna never see to bling too woure pe asc wou ik ang it zlaw donna mere ang dape the cnom me on doind been mhats cnom both me insige it saw to shp too woure but afhind been hearts wour lond so kor other eafh cnomn meve Ingerstang wou pace dotta keelind ip hom wou tell manna just epe duw other anw krop this det moulgnt wou ok thincind ip mhat foppitpents kull ah ewe go so ang rules the cnom wou love to stranders no mere

With a few manual letter swaps (e.g., "wou" $\to$ "you"), the fully decrypted message is revealed to be a modified version of the lyrics to the song "Never Gonna Give You Up" by Rick Astley:
\begin{verbatim}
you must not lie or tell donna never goodbye say donna never... 
you desert and around run donna never... 
you let donna never... 
if you give donna never... 
see to blind too... 
you're...
\end{verbatim}
